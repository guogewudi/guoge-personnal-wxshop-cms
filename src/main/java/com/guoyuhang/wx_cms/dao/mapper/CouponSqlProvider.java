...
import com.guoyuhang.wx_cms.dao.model.CouponExample.Criteria;
import com.guoyuhang.wx_cms.dao.model.CouponExample.Criterion;
...
public class CouponSqlProvider {
    ...
    public String insertSelective(Coupon record) {
        ...
        if (record.getWholeStore() != null) {
            sql.VALUES("`whole_store`", "#{wholeStore,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getWholeStore() != null) {
            sql.SET("`whole_store` = #{record.wholeStore,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Coupon record) {
        ...
        if (record.getWholeStore() != null) {
            sql.SET("`whole_store` = #{wholeStore,jdbcType=TINYINT}");
        }
