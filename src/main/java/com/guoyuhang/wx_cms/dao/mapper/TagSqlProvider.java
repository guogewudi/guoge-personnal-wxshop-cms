...
import com.guoyuhang.wx_cms.dao.model.TagExample.Criteria;
import com.guoyuhang.wx_cms.dao.model.TagExample.Criterion;
...
public class TagSqlProvider {
    ...
    public String insertSelective(Tag record) {
        ...
        if (record.getHighlight() != null) {
            sql.VALUES("`highlight`", "#{highlight,jdbcType=TINYINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getHighlight() != null) {
            sql.SET("`highlight` = #{record.highlight,jdbcType=TINYINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Tag record) {
        ...
        if (record.getHighlight() != null) {
            sql.SET("`highlight` = #{highlight,jdbcType=TINYINT}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TagExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
